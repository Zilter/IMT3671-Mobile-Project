...
public class HighScoreScore extends ListActivity implements AsyncTaskCompleteListener<JSONObject> {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if(isOnline())
        {
        	...
        	async.execute("http://www.game-details.com/gemswapper/highscorescore.php?");
        }
    }
	...
	public void onTaskComplete(JSONObject result) 
	{
		try
    	{
	        ...
	        for(int i = 0; i < highscores.length(); i++)
	        {
	        	...
	        	map.put("score", score + e.getString( "score" ));
	        	mylist.add(map);
			}        
    	} 
    	catch(Exception e)
    	...
    	ListAdapter adapter = new SimpleAdapter(this, mylist , R.layout.activity_high_score_score, 
                new String[] {"placement", "name", "score" }, 
